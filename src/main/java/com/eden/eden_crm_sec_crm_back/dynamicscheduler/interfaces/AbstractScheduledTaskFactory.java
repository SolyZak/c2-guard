...
public abstract class AbstractScheduledTaskFactory implements Runnable, ScheduledTaskFactory {
    ...
    @Override
    public AbstractScheduledTaskFactory createInstanceAndSetEntity(
            ApplicationContext applicationContext,
            ObjectMapper objectMapper,
            ScheduledTaskRepository taskRepository,
            ScheduledTaskExecutionLogRepository logRepository,
        ...
        try {
            ...
            var instance = ctor.newInstance(applicationContext, objectMapper, taskRepository, logRepository);
            instance.taskEntity = taskEntity;
            return instance;
        } catch (Exception e) {
